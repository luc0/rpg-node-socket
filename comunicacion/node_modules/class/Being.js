exports.Being = function( params ){
	...
	//----------------------------------------------------------------------------------
	// GETTERS Y SETTERS
	// Definimos variables que se envian al cliente
	//----------------------------------------------------------------------------------
	...
	Object.defineProperty(this, 'direction', {
	    ...
	    set: function(value) {
			...
			SERVER.queue({ "user" : this.name , "property" : "direction" , "value" : value });
	    }
	});
	...
	Object.defineProperty(this, 'inventory', {
	    ...
	    set: function(value) {
			...
			SERVER.queue({ "user" : this.name , "property" : "inventory" , "value" : value });
	    }
	});
	...
	Object.defineProperty(this, 'stats', {
	    ...
	    set: function(value) {
	        this._stats = value;
			SERVER.queue({ "user" : this.name , "property" : "stats" , "value" : value });
	    }
	});

	// Modificators
	Object.defineProperty(this, 'modificators', {
	    get: function() {
			return this._modificators;
	    },
	    set: function(value) {
	        this._modificators = value;
			SERVER.queue({ "user" : this.name , "property" : "modificators" , "value" : value });
	    }
	});
	...
	Object.defineProperty(this, 'state', {
	    ...
	    set: function(value) {
	        this._state = value;
			SERVER.queue({ "user" : this.name , "property" : "state" , "value" : value });
	    }
	});
	...
	Object.defineProperty(this, 'equipped', {
	    ...
	    set: function(value) {
			...
			SERVER.queue({ "user" : this.name , "property" : "equipped" , "value" : value });
	    }
	});
