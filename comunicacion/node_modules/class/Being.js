exports.Being = function( params ){
	...
	this.createControls = function(){
		if( this.controls == "pc" ){
			...
			this.controls.eventsDown.up = (function(){
				...
				this.move({"y":-1})
				this.direction = 'up';
				world.refreshTiles({ "element":this , "lastPosition":lastPosition });
			}).bind(this);
	...
	this.remove = function(){
		...
		this.updateRemoveTile({ 'object' : this , 'lastPosition' : this.position });
		this.updateWorldObjects({ "delete" : null }); // acutaliza createdObjects
	...
	*/
	...
	this.updateRemoveTile = function( params ){
		SERVER.queue({
			"tile" : null ,
			"data" : { 'object' : params.object , 'lastPosition' : params.lastPosition }
		});
	}
