exports.Being = function( params ){
	...
	this.dead = function(){
		...
		if( this.controls == 'npc' ){
			...
			clearInterval(this.timerCamina);
			console.log("Borro interval",this.timerCamina);
			this.remove();
		}
	...
	this.remove = function(){
		// Borro tile
		console.log("borro tile:",this.id)
		...
		console.log("borro instancia en world, id:",this.id)
