exports.Being = function( params ){
	...
	this.move = function( params ){
		...
		if( !this.collision({ "new_position": new_position }) ){
			...
			//------------------------------------------
			// Envio datos actualizados a los clientes.
			//------------------------------------------
			/*
			SERVER.queue({
				 "being" : this.name ,
...
*/
		...
		return { "success" : false , "colision" : this.world.getTile( new_position ) }
	}
	...
	this.isAffected = function( params ){
		...
		for( var stat in stats){
			...
			SERVER.queue({
				 "being" : this.name ,
				 "controls" : this.controls,
				 "data" : { "all" : [ { "three" : ['stats',stat] , "value" : this.stats[stat] } ] }
			});
*/
	...
	this.throw = function( params ){
		...
		if( params.clone){
			...
			this.world.getTile( params.position ).artifact = clonedArtifact;
		...
		// si Tile vacio -> Tira el Artifact (el total de lo que tenga)
			...
			this.world.getTile( params.position ).artifact = params.artifact;
		}
	...
	*/
	...
	this.createArtifact = function( params ){
		...
		var newArtifact = new artifact({"position":this.position} , this.world );
